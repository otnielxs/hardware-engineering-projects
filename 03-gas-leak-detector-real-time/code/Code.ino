...
#define WIFI_SSID "WIFI NAME" // Sesuaikan dengan Tethring
...
const String botToken = "TOKEN";  // Token bot Telegram 
const String chatIDs[] = {"xxxxx", "yyyyy", "zzzzzz"};  // Chat ID pengguna (mis Mahasiswa atau Dosen)
